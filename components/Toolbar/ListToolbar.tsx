...
import { indent, orderListItems, outdent, outdentFull, unorderListItems } from "src/utils/list-operations";
...
export const ListToolbar = (props: { onClose: () => void }) => {
  ...
  let isList = useEntity(focusedBlock?.entityID || null, "block/is-list");
  let listStyle = useEntity(focusedBlock?.entityID || null, "block/list-style");
  ...
  return (
    <div className="flex items-center gap-[6px]">
      ...
      <ToolbarButton
        ...
        tooltipContent={
          <div className="flex flex-col gap-1 justify-center">
            <div className="text-center">Unordered List</div>
        ...
        tooltipContent={
          <div className="flex flex-col gap-1 justify-center">
            <div className="text-center">Ordered List</div>
            <div className="flex gap-1 justify-center"></div>
          </div>
        }
        onClick={() => {
